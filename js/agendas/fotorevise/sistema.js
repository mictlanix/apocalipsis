...
//$(document).ready(function($) {
   ...
   //poner el ancla	
	...
	$('body').on('click','.principal_menu', function (e) {   
		var catalogo= hash_url+'agendas/agendas';
 ...
 //////////////////////////////////////////////////////////////////////////
    ...
    //ok
    var url = hash_url+'agendas/activar_carrito'; 
				$.ajax({
				    url: url,
				    method: "POST",
			        dataType: 'json',
  ...
  ---Queda que se guarde la imagen del formulario
	...
	*/
	...
	//ok eliminar un id_tamaño especifico
	$('body').on('click','.eliminar_slider', function (e) {   
       ...
       //okCuando cancela la "ELIMINACION DE UN TAMAÑO"
	    ...
	    $('body').on('click','#eliminar_diseno', function (e) {
		    ...
		    var url = hash_url+'agendas/eliminar_diseno_revise'; 
				$.ajax({
				    url: url,
				    method: "POST",
			        dataType: 'json',
...
////////////////////////////////////////////////////////////////////////////////////////
	...
	$('body').on('click','.agregar_carrito[marcado="si"]', function (e) {   
		...
		//var spinner = new Spinner(opts).spin(target2);	
			 			...
			 			var url = hash_url+'agendas/guardar_info_revise'; 
