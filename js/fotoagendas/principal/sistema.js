...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////  
 ...
 //para cuando refresque "continuar, personaliza_menu y notificaciones esten actualizadas"
    ...
    var url = hash_url+'fotoagendas/leer_marcados'; 
        $.ajax({
            url: url,
            method: "POST",
              dataType: 'json',
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////dibujar los tipos de fotoagendas////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////  
           ...
           $(this).find(".variations-table .select-option.swatch-wrapper").each(function(i) {
                  console.log(i);
                      ...
                      var producto_variable =''; 
                         ...
                         producto_variable += '<img src="'+imag_prod+'" height="100" width="100" imagen_diseno="'+imag_diseno+'">'; 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
   ...
   $('body').on('click','.agregar_cancelar', function (e) {        
          ...
          var url = hash_url+'fotoagendas/guardar_info'; 
          $.ajax({
                  url: url,
                 type: 'POST',
             dataType: 'json',
            ...
            success: function(todos){
                ...
                arreglo_producto = {};     
                 ...
                 if (todos.resultado) {
                    var catalogo= hash_url+'fotoagendas/fotocalendario/'+$.base64.encode(session_id);
