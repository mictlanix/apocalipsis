...
//$(document).ready(function($) {
   ...
   //poner el ancla	
	...
	$('body').on('click','.principal_menu', function (e) {   
		var catalogo= hash_url+'fotolibretas/fotolibretas';
 ...
 //////////////////////////////////////////////////////////////////////////
    ...
    var url = hash_url+'fotolibretas/activar_carrito'; 
				$.ajax({
				    url: url,
				    method: "POST",
			        dataType: 'json',
	...
	$('body').on('click','.eliminar_slider', function (e) {   
       ...
       //Cuando cancela la "ELIMINACION DE UN TAMAÑO"
	    ...
	    $('body').on('click','#eliminar_diseno', function (e) {
		    ...
		    var url = hash_url+'fotolibretas/eliminar_diseno_revise'; 
				$.ajax({
				    url: url,
				    method: "POST",
			        dataType: 'json',
...
////////////////////////////////////////////////////////////////////////////////////////
	...
	$('body').on('click','.agregar_carrito[marcado="si"]', function (e) {   
		...
		//var spinner = new Spinner(opts).spin(target2);	
			 			...
			 			var url = hash_url+'fotolibretas/guardar_info_revise'; 
...
/*
 			...
 			$.get(url_base+'?add-to-cart='+id_diseno+'&quantity='+id_copia+
									     	'&variation_id='+variation_id+'&attribute_pa_variacions='+nombre, function(resp) {
       					 
	

			 			var url = hash_url+'fotolibretas/guardar_historico_informacion'; 
							$.ajax({
							    url: url,
							    method: "POST",
						        dataType: 'json',
