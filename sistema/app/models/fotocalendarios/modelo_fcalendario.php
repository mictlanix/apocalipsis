...
//new
 ...
 public function actualizar_disenos_old( $data ){
          ...
          $this->db->select("t.id_session, t.consecutivo, t.correo, t.id_diseno, t.id_tamano, t.variation_id, t.nombre_diseno,t.descripcion_tamano, t.nombre_tamano,t.imagen_diseno, t.imagen_tamano, t.fecha_mac");         
