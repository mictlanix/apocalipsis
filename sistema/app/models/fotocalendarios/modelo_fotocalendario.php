...
///////////////////////////////////////////////////////////////////////////    
   ...
   public function correo_logueo($data){
              $this->db->select("id, id_session, consecutivo, correo, id_diseno, id_tamano, nombre_diseno,descripcion_tamano, nombre_tamano,imagen_diseno, imagen_tamano, image_link,logos, fecha_mac");                
...
//OK para activar "previsualizar" cuando ya estan las 12 imagenes
 ...
 public function elemento_imagen($data){
           ...
           // $this->db->select("COUNT(id_diseno) as cantidad",false); 
            ...
            $info = $this->db->get();
            if ($info->num_rows() > 0) {
                return 0;  //significa q ya existe no hay q sumar nada
            }    
            else
