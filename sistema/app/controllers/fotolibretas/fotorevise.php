...
class Fotorevise extends CI_Controller {
	public function __construct(){ 
		...
		$this->load->model('fotolibretas/modelo_revise', 'modelo_revise'); 
    ...
    public function index($session){
    	   ...
    	   $this->load->view( 'sitio/fotolibretas/fotorevise/revise', $data );	
  ...
  //ok **
	...
	public function guardar_info_revise(){
    	...
    	$adding_to_cart      = wc_get_product( $product_id );		
  		...
  		$variations = ( (array)((object)($variations)) ); //Array ( [attribute_pa_tamano_fotolibretas] => 11x15 [attribute_pa_interior] => punteado [attribute_pa_num_hojas] => 100-hojas )
