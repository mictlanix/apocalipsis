...
//comienza aqui a mostrar el formulario
	public function index(){
		...
		//$session = $this->input->cookie('wp_woocommerce_session_a6b655384669611c0dbcf244a3aa0b3e');
		 ...
		 //print_r(get_site_url());
			...
			try {
			    ...
			    $datos['las_categorias_productos'] = $categorias->product_categories;
    			 ...
    			 $datos['productos']= ( $client->products->get(null,array('filter[limit]' => 600,'filter[category]'=>'fcalendario')) );
			...
			$this->load->view( 'sitio/fotocalendario/principal/principal',$datos ); 
