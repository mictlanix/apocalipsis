...
class fotoagendas extends CI_Controller {
	public function __construct(){ 
		parent::__construct();
		$this->load->model('fotoagendas/modelo_fcalendario', 'modelo_fcalendario'); 
	...
	public function index(){
			...
			//$this->load->view( 'sitio/fotoagendas/principal/principal',$datos ); 
			$this->load->view( 'sitio/fotoagendas/principal/principal'); 
...
/*  Array ( [modelo] => este es fotoagendas 
			...
			[variaciones_producto] => Array ( 
				[0] => Array ( 
						[nombre_diseno] => este es fotoagendas
				...
				[1] => Array ( [nombre_diseno] => este es fotoagendas [nombre_variacion] => tip_agenda1 [descripcion_variacion] => tipo1 agenda [variation_id] => 215 [imagen_variacion] => http://tinbox.dev.com/wp-content/uploads/2016/02/1_cd-1.jpg ) ) 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
	...
	public function guardar_info_revise(){
    	...
    	$adding_to_cart      = wc_get_product( $product_id );		
  		...
  		$variations=Array ( 
            "[attribute_pa_variacion_fotoagendas]" => $producto['pa_variacion_fotoagendas'],
