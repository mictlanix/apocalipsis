...
class Fotoimagen extends CI_Controller {
	public function __construct(){ 
		...
		$this->load->model('fotoagendas/modelo_fotoimagen', 'modelo_fotoimagen'); 
	...
	public function index($session) {
		...
		if  ($data['datos'] ) {
			$this->load->view( 'sitio/fotoagendas/fotoimagen/croppear',$data );	
			
			//$this->load->view( 'sitio/fotoagendas/fotoimagen/ancla',$data );	
	...
	public function buscarImagen(){
		...
		$data['imagen'] = $img_canva.'<script src="'.base_url().'js/fotoagendas/fotoimagen/main.js" type="text/javascript"></script>';	
		    ...
		    mkdir($dir,0755,TRUE);  
 		 	  ...
 		 	  if (!empty($_FILES)) {
		          ...
		          $this->load->library('upload', $config_adjunto);
				   ...
				   echo '<script src="'.base_url().'js/fotoagendas/fotoimagen/main.js" type="text/javascript"></script>';
	}	
