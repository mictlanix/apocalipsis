...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/libreta_corporativa/fotocalendario/header' ); ?>
      
 <div class="container">

        
        
        <?php $this->load->view( 'sitio/libreta_corporativa/fotocalendario/navbar_fotocalendario' ); ?>

     
        <?php $this->load->view( 'sitio/libreta_corporativa/fotocalendario/slider' ); ?>
...
<?php 
 ...
 echo form_open_multipart('libreta_corporativa/validar_nuevo_fotocalendario', $attr);
?>    
             ...
             <div class="col-md-12 mb-20">
                           <div class="img_logo">
                             <p class="mb-20">Su imagen adjunta actual es: </p>
                                            ...
                                            <?php  
                                                  $nombre_fichero ='uploads/libreta_corporativa/fotocalendario/'.$calendario->logo;
...
<div class="modal fade" id="modalPregunta" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php $this->load->view( 'sitio/libreta_corporativa/fotocalendario/guardar_lista', $dato ); ?>
...
<div class="modal fade" id="modalsinLista" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            <?php $this->load->view( 'sitio/libreta_corporativa/fotocalendario/singuardar_lista' ); ?>
        </div>
    </div>
</div>  
...
<?php $this->load->view( 'sitio/libreta_corporativa/fotocalendario/footer' );
 get_footer('sistema'); 
?>
<style type="text/css">
