...
<?php //echo anchor('sitio/fotolibretas/fotoimagen/croppear/foo', 'Try it again!'); ?>

<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotolibretas/fotoimagen/header' ); ?>   
...
<input type="text" id="mesclick" name="mesclick" value="" >
  ...
  <div class="container">
      <?php $this->load->view( 'sitio/fotolibretas/fotoimagen/navbar' ); ?> 
      ...
      <?php $this->load->view( 'sitio/fotolibretas/fotoimagen/slider',$datos); ?>
...
<?php $this->load->view( 'sitio/fotolibretas/fotoimagen/footer' ); 
get_footer('sistema'); 
?>
