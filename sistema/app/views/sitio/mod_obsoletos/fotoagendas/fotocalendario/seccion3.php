...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotoagendas/fotocalendario/header' ); ?>
      
 <div class="container">

        
        
        <?php $this->load->view( 'sitio/fotoagendas/fotocalendario/navbar_fotocalendario' ); ?>

     
        <?php $this->load->view( 'sitio/fotoagendas/fotocalendario/slider' ); ?>
...
<?php 
 ...
 echo form_open_multipart('fotoagendas/validar_nuevo_fotocalendario', $attr);
...
<input type="text" id="uid_fotocalendario" name="uid_fotocalendario" value="<?php echo $uid_fotocalendario; ?>" >
      ...
      <div class="alert" id="messages"></div>
            ...
            <div id="datos">
              ...
              <div class="row">  
                <div class="col-xs-12 col-md-12">
                      <h3 class="form-control-static text-left">DATOS</h3>
                </div>  
              </div>  
        ...
        <div class="row">
                 ...
                 <div class="col-md-7 col-sm-7 col-xs-0"></div>
...
<!-- campo predictivo de titulo -->            
            <div class="form-group">
              <label for="titulo">Escriba su título:</label>
              ...
              <input value="<?php echo $calendario->titulo; ?>" type="text" id="otro" name="otro" style="display: <?php echo (($personalizado == '') ? '' : 'none'); ?>;"/>
                  <div class="col-xs-12 col-md-12">
                    <span class="help-block">*Sólo aparecerá en la portada antes del nombre, ejemplo (Licenciada, Estimada, Sr. ...)</span>
                  </div>              
            </div>
              ...
              <div id="interior" class="row">  
                    ...
                    <div class="col-xs-12 col-md-12">
                        <h3 class="form-control-static text-left">¿Quiéres incluir un logo?</h3>
                    </div>  
             ...
             <div class="col-md-12 mb-20">
                           <div class="img_logo">
                             <p class="mb-20">Su imagen adjunta actual es: </p>
                                            ...
                                            <?php  
                                                  $nombre_fichero ='uploads/fotoagendas/fotocalendario/'.$calendario->logo;
        ...
        <div class="row">
          <div class="col-md-12">
                  ...
                  <br/><br/><br/><br/>
                  <span><b style="color:#000 !important;">*Campos obligatorios</b></span>  
              </div> <!-- row -->
        ...
        <hr>
              <div id="cumpleano" class="row">   
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-6" id="mesano">
        ...
        <hr>
              ...
              <div id="festividades" class="row">  
                <div class="col-xs-12 col-md-12">
                  ...
                  <label style="padding-top: 7px;" class="col-md-2 col-sm-4 col-xs-6 control-label">Festividades</label>
            ...
            <div id="fechas_especiales">
              <div class="row">  
                 <div class="col-md-12">
                      <h3 class="form-control-static text-left">FECHAS ESPECIALES</h3>
                  </div>  
                </div>  
...
<div class="modal fade" id="modalPregunta" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php $this->load->view( 'sitio/fotoagendas/fotocalendario/guardar_lista', $dato ); ?>
...
<div class="modal fade" id="modalsinLista" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            <?php $this->load->view( 'sitio/fotoagendas/fotocalendario/singuardar_lista' ); ?>
        </div>
    </div>
</div>  
...
<?php $this->load->view( 'sitio/fotoagendas/fotocalendario/footer' );
 get_footer('sistema'); 
?>
