<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>css/agendas/principal/estilo.css">

 

      <!-- Estilo del calendario -->
    <link rel="stylesheet" href="<?php echo base_url();?>css/agendas/fotocalendario/calendarioEventos.css">

    <!-- Plugins dependiente para mostrar las fechas -->
    <script src="<?php echo base_url(); ?>js/agendas/fotocalendario/moment.js" type="text/javascript"></script>

    <script src="<?php echo base_url(); ?>js/agendas/fotocalendario/estrategas.calendarioEventos.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/agendas/fotocalendario/calendario.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url(); ?>js/agendas/fotocalendario/sistema.js" type="text/javascript"></script>
