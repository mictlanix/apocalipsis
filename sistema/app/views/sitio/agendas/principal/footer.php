<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
    ...
    <script src="<?php echo base_url(); ?>js/agendas/principal/moment.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/agendas/principal/sistema.js" type="text/javascript"></script>
