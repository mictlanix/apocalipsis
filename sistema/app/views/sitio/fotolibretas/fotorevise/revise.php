...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotolibretas/fotorevise/header' ); ?>
...
<input type="text" id="ano" name="ano" value="<?php echo $ano; ?>" >
  ...
  <div class="container">
      ...
      <?php $this->load->view( 'sitio/fotolibretas/fotorevise/navbar' ); ?>
      <?php $this->load->view( 'sitio/fotolibretas/fotorevise/acordion' ); ?>
...
<?php $this->load->view( 'sitio/fotolibretas/fotorevise/footer' ); 
get_footer('sistema'); 
?>
