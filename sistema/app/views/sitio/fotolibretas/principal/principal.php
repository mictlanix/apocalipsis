...
<?php 
  get_header('sistema');
  $this->load->view( 'sitio/fotolibretas/principal/header' ); 
  $this->load->view( 'sitio/fotolibretas/principal/menu' );
?>
        ...
        if ( $loop->have_posts() ) {
            while ( $loop->have_posts() ) : $loop->the_post();
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-6 diseno">
                      ...
                      <?php
                        $this->load->view( 'sitio/fotolibretas/principal/modal'); 
...
<?php 
  ...
  $this->load->view( 'sitio/fotolibretas/principal/footer' );
  get_footer('sistema'); 
