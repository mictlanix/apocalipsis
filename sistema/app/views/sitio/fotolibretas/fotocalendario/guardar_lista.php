...
<?php
 	if (!isset($retorno)) {
      	$retorno ="tinbox/fotolibretas/fotocalendario";
    }
 $hidden = array('lista'=>''); 
?>
<?php echo form_open_multipart('fotolibretas/guardar_lista', array('class' => 'form-horizontal','id'=>'form_guardar_lista','name'=>$retorno, 'method' => 'POST', 'role' => 'form', 'autocomplete' => 'off' ) ,   $hidden ); ?>
	...
	<div class="modal-footer">
		...
		<button class="btn btn-default agregar_cancelar" name="noguardar" id="deleteUserSubmit">No me interesa, deseo continuar</button>
