...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotolibretas/fotocalendario/header' ); ?>
      
 <div class="container">

        
        
        <?php $this->load->view( 'sitio/fotolibretas/fotocalendario/navbar_fotocalendario' ); ?>

     
        <?php $this->load->view( 'sitio/fotolibretas/fotocalendario/slider' ); ?>
...
<?php 
 ...
 echo form_open_multipart('fotolibretas/validar_nuevo_fotocalendario', $attr);
?>    
             ...
             <div class="col-md-12 mb-20">
                           <div class="img_logo">
                             <p class="mb-20">Su imagen adjunta actual es: </p>
                                            ...
                                            <?php  
                                                  $nombre_fichero ='uploads/fotolibretas/fotocalendario/'.$calendario->logo;
...
<div class="modal fade" id="modalPregunta" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php $this->load->view( 'sitio/fotolibretas/fotocalendario/guardar_lista', $dato ); ?>
...
<div class="modal fade" id="modalsinLista" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            <?php $this->load->view( 'sitio/fotolibretas/fotocalendario/singuardar_lista' ); ?>
        </div>
    </div>
</div>  
...
<?php $this->load->view( 'sitio/fotolibretas/fotocalendario/footer' );
 get_footer('sistema'); 
?>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('.navbar-nav li:nth-child(7)').addClass('current-menu-item')
  });
</script>
