...
<?php //echo anchor('sitio/fotoagendas/fotoimagen/croppear/foo', 'Try it again!'); ?>

<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotoagendas/fotoimagen/header' ); ?>   
...
<input type="text" id="mesclick" name="mesclick" value="" >
  ...
  <div class="container">
      <?php $this->load->view( 'sitio/fotoagendas/fotoimagen/navbar' ); ?> 
      ...
      <?php $this->load->view( 'sitio/fotoagendas/fotoimagen/slider',$datos); ?>
...
<?php $this->load->view( 'sitio/fotoagendas/fotoimagen/footer' ); 
get_footer('sistema'); 
?>
