<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
    ...
    <script src="<?php echo base_url(); ?>js/fotoagendas/principal/moment.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>js/fotoagendas/principal/sistema.js" type="text/javascript"></script>
