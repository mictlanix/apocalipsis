...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/calendarios/fotocalendario/header' ); ?>
      
 <div class="container">

        
        
        <?php $this->load->view( 'sitio/calendarios/fotocalendario/navbar_fotocalendario' ); ?>

     
        <?php $this->load->view( 'sitio/calendarios/fotocalendario/slider' ); ?>
...
<?php 
 ...
 echo form_open_multipart('calendarios/validar_nuevo_fotocalendario', $attr);
              ...
              <div id="interior" class="row" style="display:<?php echo ($datos[0]->logos=='' ? 'none': 'block' ) ?>">  
                  ...
                  <?php          
                             ...
                             <div class="col-md-12 mb-20">
                                         <div class="img_logo">
                                           <p class="mb-20">Su imagen adjunta actual es: </p>
                                                            ...
                                                            <?php  
                                                                $nombre_fichero ='uploads/calendarios/fotocalendario/'.$calendario->logo;

                                                                if (file_exists($nombre_fichero)) {
                                                                  echo '<a target="_blank" href="'.base_url().$nombre_fichero.'" type="button">';
                                                                        echo '<img src="'.base_url().$nombre_fichero.'" border="0" style="width:250px; height:auto; margin:15px 0">';
                                                                  echo '</a>';  
                                                                } else {
                                                                    
                                                                  echo '<a target="_blank" href="'.base_url().'img/sinimagen.jpg'.'" type="button">';
                                                                        echo '<img src="'.base_url().'img/sinimagen.jpg'.'" border="0" style="width:250px; height:auto; margin:15px 0">';
                                                                    echo '</a>';    
                                                                }
                                                            ?>
                   ...
                   <div class="col-md-6">
                        ...
                        <input style="visibility: hidden; position: absolute;" type="file" name="logo" id="logo" size="20" onchange="loadFile(event)">
          ...
          <!-- Imagen--> 
            ...
            <div id="fechas_especiales">
              ...
              <div class="row clearfix">
              	  <div class="col-xs-12 col-md-12">
                        <h3 class="form-control-static text-left mb-0">Agrega un mensaje para cada mes (máximo 40 caracteres)</h3>
                  </div>
                  <div class="col-md-12">
              ...
              <div class="row"> 
                ...
                <div class="col-md-4 col-md-offset-8" style="margin-bottom:30px">
                  <input type="submit" id="cont_session3" class="btn btn-default btn-block" value="Continuar"/> 
                  <!--
...
<div class="modal fade" id="modalPregunta" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php $this->load->view( 'sitio/calendarios/fotocalendario/guardar_lista', $dato ); ?>
...
<div class="modal fade" id="modalsinLista" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            <?php $this->load->view( 'sitio/calendarios/fotocalendario/singuardar_lista' ); ?>
        </div>
    </div>
</div>  
...
<?php $this->load->view( 'sitio/calendarios/fotocalendario/footer' );
  get_footer('sistema'); 
