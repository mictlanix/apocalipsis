...
<?php
 	if (!isset($retorno)) {
      	$retorno ="tinbox/calendarios/fotocalendario";
    }
 $hidden = array('lista'=>''); 
?>
<?php echo form_open_multipart('calendarios/guardar_lista', array('class' => 'form-horizontal','id'=>'form_guardar_lista','name'=>$retorno, 'method' => 'POST', 'role' => 'form', 'autocomplete' => 'off' ) ,   $hidden ); ?>
