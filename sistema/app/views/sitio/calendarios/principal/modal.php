                            ...
                            <!-- Derecha -->
                             <div class="col-md-6 col-sm-6 col-xs-6 blanco-der">
                                  <div class="notif-cont"> 
                                            <i class="fa fa-calendar"></i><span class="notificacion"></span><span class="cs">CALENDARIOS SELECCIONADOS</span>    
                                  </div>
                                  ...
                                  <div class="modal-footer">
                                            <button class="btn btn-default agregar_cancelar" value="<?php echo get_the_ID() ?>" id="agregar_cancelar"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Agregar Otro diseño<span class="fc"> de calendario</span></button><br>
