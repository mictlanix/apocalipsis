...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotocalendario/fotocalendario/header_fotocalendario' ); ?>
      
 <div class="container">

        
        <?php $this->load->view( 'sitio/fotocalendario/fotocalendario/navbar_fotocalendario' ); ?>

     
        <?php $this->load->view( 'sitio/fotocalendario/fotocalendario/slider' ); ?>
...
//echo $actual_link;
 ...
 echo form_open_multipart('fotocalendario/validar_nuevo_fotocalendario', $attr);
              ...
              <div id="interior" class="row">  
                  ...
                  <?php          
						 ...
						 <div class="col-md-12 mb-20">
                           <div class="img_logo">
                           	 <p class="mb-20">Su imagen adjunta actual es: </p>
                                            ...
                                            <?php  
                                                  $nombre_fichero ='uploads/fotocalendario/fotocalendario/'.$calendario->logo;
                   ...
                   <div class="col-md-6">
                        ...
                        <input style="visibility: hidden; positio/fotocalendarion: absolute;" type="file" name="logo" id="logo" size="20">
...
<div class="modal fade" id="modalPregunta" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php $this->load->view( 'sitio/fotocalendario/fotocalendario/guardar_lista', $dato ); ?>
...
<div class="modal fade" id="modalsinLista" role="dialog" >  
  <div class="modal-dialog">
        <div class="modal-content">
            <?php $this->load->view( 'sitio/fotocalendario/fotocalendario/singuardar_lista' ); ?>
        </div>
    </div>
</div>  
...
<?php $this->load->view( 'sitio/fotocalendario/fotocalendario/footer_fotocalendario' );
  get_footer('sistema'); 
?>
