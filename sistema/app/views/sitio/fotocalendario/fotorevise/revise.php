...
<?php 
get_header('sistema'); 
$this->load->view( 'sitio/fotocalendario/fotorevise/header' ); ?>
...
<span style="display:none">
  ...
  <div class="container">
      ...
      <?php $this->load->view( 'sitio/fotocalendario/fotorevise/navbar' ); ?>
      <?php $this->load->view( 'sitio/fotocalendario/fotorevise/acordion' ); ?>
...
<?php $this->load->view( 'sitio/fotocalendario/fotorevise/footer' ); 
get_footer('sistema'); 
?>
