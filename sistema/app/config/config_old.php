...
*/
$config['base_url']	='http://beta.tinbox.mx/sistema/'; // 'http://45.55.85.45';
...
Echa un vistazo a sess_read () y sess_update () en /system/libraries/Session.php
"last_activity" para una sesión activa se actualiza cada cinco minutos.
Sesión de caducidad está marcada con "last_activity + sess_expiration < now"
Así, por el comportamiento que desea, acaba de establecer su tiempo 
     sess_expiration a 86.400 (un día), y usted debe estar todo listo.

Predeterminado tiempo de la sesión en CodeIgniter es
 $sess_expiration = 7200; // This is 2 hours 
También puede establecer $sess_expiration = 0; Esto significa que está configurando la sesión para siempre.
En realidad, yo pude ver en CodeIgniter biblioteca session.php
...
//http://cassianinet.blogspot.mx/2012/06/codeigniter-sesiones-hook-y-base-de.html
