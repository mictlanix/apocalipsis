  ...
  $('.modal').on('shown.bs.modal', function(e) {
    ...
    $(".continuar").click(function(e) {
          ...
          if  ( $('.agregar_cancelar').prop('disabled') != false ) {
                        ...
                        var catalogo= hash_url+'fotolibretas/fotocalendario/'+$.base64.encode(session_id);
              ...
              var url = hash_url+'fotolibretas/guardar_info'; 
              $.ajax({
                      url: url,
                     type: 'POST',
                 dataType: 'json',
                ...
                success: function(todos){
                    ...
                    arreglo_producto = {};     
                     ...
                     if (todos.resultado) {
                          var catalogo= hash_url+'fotolibretas/fotocalendario/'+$.base64.encode(session_id);
                          //var catalogo= hash_url+'fotolibretas/fotocalendario/'+session_id;
                          window.location.href = catalogo; 
                      }                   
   ...
   $('body').on('click','.agregar_cancelar', function (e) {        
    ...
    $('.modal_prod').on('hide.bs.modal', function(e) {
        ...
        $('.agregar_cancelar').prop('disabled', true);            
                    ...
                    var url = hash_url+'fotolibretas/leer_marcados'; 
                        $.ajax({
                            url: url,
                            method: "POST",
                              dataType: 'json',
