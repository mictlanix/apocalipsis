$(function () {
  ...
  //Estableciendo la relación de aspecto
        ...
        minCanvasHeight:490, //minimo Alto de la imagen 
      ...
      built:function(){
            ...
            $('#image').cropper("setCropBoxData", { width: 801, height: 490 });     



              if ( parseFloat($('#image').attr('total_elementos')) >=12 ) {
                  $('#guardar').css('display', '');   
                  $('.previo_slider[value="'+$('#variation_id').val()+'"][consecutivo="'+$('#consecutivo').val()+'"][diseno="'+$('#id_diseno').val()+'"]').prop('disabled', false);  
              }  
  ...
  var result;
    ...
    if ($image.data('cropper')) {
           ...
           var croppedImageDataURL = result.toDataURL(tipo_archivo); 
            ...
            //guardar imagen      
            $.ajax(hash_url+'fotolibretas/guardar_imagen', {
              method: "POST",
              data: formData,
              processData: false,
              contentType: false,
              success: function(data) {  
                    ...
                    var catalogo = hash_url+'fotolibretas/fotoimagen/'+$.base64.encode(id_session);
            ...
            $.ajax(hash_url+'fotolibretas/guardar_imagen', {
              ...
              success: function(data) {  
                    ...
                    */
                    ...
                    $.ajax({
                          url: hash_url+'fotolibretas/revisar_imagenes',
                          method: "POST",
                          dataType: 'json',
                          data: {
                          ...
                          success: function(cant_imagen) { 
                            if (cant_imagen <=1) {
                                ...
                                var catalogo= hash_url+'fotolibretas/fotocalendario/'+$.base64.encode(id_session);
...
$('body').on('click', '#guardar', function (e) {
    ...
    if (!(e.isTrigger)) { 
        ...
        if (revisa_compra == 'si') { //si ya se activo "revisa y compra"-> es decir es el ultimo elemento
                   ...
                   var id_edicion_variacion      = $(this).attr('value');
                  ...
                  if ( existe != undefined) { //si hay imagen para guardar
                            guardar5(id_edicion_variacion, id_edicion_diseno, id_edicion_consecutivo);
                  } else { //no hay imagen para guardar

                       var catalogo= hash_url+'fotolibretas/fotorevise/'+$.base64.encode(id_session);
                        hrefPost('POST', catalogo, {
                              id_diseno  : id_diseno,
                              variation_id  : variation_id,
                              consecutivo  : consecutivo,
...
function guardar4(id_edicion_variacion, id_edicion_diseno, id_edicion_consecutivo) {
  var result;
            ...
            $.ajax(hash_url+'fotolibretas/guardar_imagen', {
              ...
              success: function(data) {  
                    ...
                    var catalogo = hash_url+'fotolibretas/fotocalendario/'+$.base64.encode(id_session);
                                ...
                                hrefPost('POST', catalogo, {
                                      id_edicion_variacion : id_edicion_variacion,
...
function guardar5(id_edicion_variacion, id_edicion_diseno, id_edicion_consecutivo) {
  var result;
            ...
            $.ajax(hash_url+'fotolibretas/guardar_imagen', {
              ...
              success: function(data) {
                ...
                */
                ...
                hrefPost('POST', catalogo, {
                    variation_id   : id_edicion_variacion,
...
$('body').on('click','.editar_slider', function (e) {   
      //Este trigger fue invocado a la fuerza "para cambiar de mes"
        ...
        if ( existe != undefined) { //si hay imagen para guardar
                  guardar4(id_edicion_variacion, id_edicion_diseno, id_edicion_consecutivo);
        } else { //no hay imagen para guardar
                    var catalogo= hash_url+'fotolibretas/fotocalendario/'+$.base64.encode(id_session);
                    hrefPost('POST', catalogo, {
                         id_edicion_variacion      : id_edicion_variacion,
  ...
  $('body').on('click','.personaliza_menu', function (e) {   
        ...
        if ( existe != undefined) { //si hay imagen para guardar
                  guardar4(variation_id, id_diseno, consecutivo);
