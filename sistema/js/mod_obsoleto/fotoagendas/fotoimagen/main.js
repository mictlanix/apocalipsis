...
function uploadFormData(formData) {
  ...
  $.ajax({
    url: hash_url1+'fotoagendas/upload',
    type: "POST",
    data: formData,
    contentType:false,
    cache: false,
  ...
  var result;
    ...
    if ($image.data('cropper')) {
           ...
           var croppedImageDataURL = result.toDataURL(tipo_archivo); 
            ...
            //guardar imagen      
            $.ajax(hash_url+'fotoagendas/guardar_imagen', {
              method: "POST",
              data: formData,
              processData: false,
              contentType: false,
              success: function(data) {  
                    ...
                    var catalogo = hash_url+'fotoagendas/fotoimagen/'+$.base64.encode(id_session);
            ...
            $.ajax(hash_url+'fotoagendas/guardar_imagen', {
              ...
              success: function(data) {  
                    ...
                    */
                    ...
                    $.ajax({
                          url: hash_url+'fotoagendas/revisar_imagenes',
                          method: "POST",
                          dataType: 'json',
                          data: {
