...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////  
 ...
 //para cuando refresque los BOTONES "continuar, personaliza_menu y notificaciones esten actualizadas"
    ...
    var url = hash_url+'fotocalendario/leer_marcados'; 
        $.ajax({
            url: url,
            method: "POST",
              dataType: 'json',
          ...
          $.ajax({
            ...
            success: function(todos){
                arreglo_producto = {};     
                 ...
                 if (todos.resultado) {
                        var catalogo= hash_url+'fotocalendario/fotocalendario/'+$.base64.encode(session_id);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////  
 ...
 $('body').on('click','.continuar', function (e) {        
        ...
        if  ( $('.agregar_cancelar').prop('disabled') != false ) {
              ...
              var url = hash_url+'fotocalendario/guardar_tamanos'; 
              $.ajax({
                      url: url,
                     type: 'POST',
                 dataType: 'json',
