...
*/
 ...
 //http://forums.asp.net/t/2067871.aspx?error+in+pluload+on+check+image+size+parameter+1+is+not+of+type+Blo+asp+net+MVC
...
*/
		                ...
		                if  (!file.identificador) {
 						...
 						/*
 						console.log('fuente',file.getSource());	
