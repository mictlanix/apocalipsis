...
(function($) {
    ...
    $(document).on("click", ".tc-extra-product-options .use_images_containter .tmcp-field-wrap label", function() {
        return false;
    });

    $(document).on("click", ".tm-epo-variation-section label img,.tc-extra-product-options label img, .tc-extra-product-options label .tmhexcolorimage", function() {
            ...
            targets.on( 'mouseenter tmshowtooltip', function(){
                ...
                var init_tooltip = function(nofx){
                    ...
                    var u               = $.tm_getPageScroll(),
                        ...
                        pos_from_top    = target.offset().top-u[1]-tooltip.outerHeight();
                ...
                target
                .on( 'tmmovetooltip', function(){target.data('is_moving',true);init_tooltip(1);} )
                .on( 'mouseleave tmhidetooltip', remove_tooltip );
                tooltip.on( 'click', remove_tooltip );
            });
            return targets;
