                        ...
                        if ( field_is_active( field ) ){ 
                            ...
                            if (field.is('.tmcp-checkbox, .tmcp-radio')) {
                                if (field.is(':checked')) {
                                    ...
                                    _value=field.closest('li.tmcp-field-wrap').find('.checkbox_image_label,.radio_image_label');
                                    if (_value.length){
                                        _value=_value.html();
                                    }else{
                                    ...
                                    if (field.is('.use_images')){
                                        _value=_value+field.closest('li.tmcp-field-wrap').find('.checkbox_image,.radio_image').clone().addClass('tc-img-floating')[0].outerHTML;
                                    }
