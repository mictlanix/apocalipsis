...
final class TM_EPO_BUILDER_base {
			...
			array(
				...
				"sectionstyle"=>array(
					...
					"options" 	=> array(
						...
						array( "text" => __( "Expand and Collapse (start opened)", TM_EPO_TRANSLATION ), "value"=>"collapse" ,"class"=>"builder_hide_for_variation-reset"),
						array( "text" => __( "Expand and Collapse (start closed)", TM_EPO_TRANSLATION ), "value"=>"collapseclosed","class"=>"builder_hide_for_variation-reset" ),
						array( "text" => __( "Accordion", TM_EPO_TRANSLATION ), "value"=>"accordion","class"=>"builder_hide_for_variation-reset" )
					),
				...
				"sectiontype"=>array(
					...
					"options" 	=> array(
						...
						array( "text" => __( "Slider (wizard)", TM_EPO_TRANSLATION ), "value"=>"slider", "class"=>"builder_hide_for_variations")
					),
	...
	private function init_elements(){
		...
		if ($this->woo_subscriptions_check){			
			$this->elements_array["textarea"][24]['options'][]=array( "text"=> __( "Subscription fee", TM_EPO_TRANSLATION ), "value"=>"subscriptionfee" );
			$this->elements_array["textfield"][24]['options'][]=array( "text"=> __( "Subscription fee", TM_EPO_TRANSLATION ), "value"=>"subscriptionfee" );
			$this->elements_array["date"][23]['options'][]=array( "text"=> __( "Subscription fee", TM_EPO_TRANSLATION ), "value"=>"subscriptionfee" );
		}
	...
	public final function add_setting_price_type($name=""){
		return array(
					...
					"options"	=> array(
						...
						array( "text"=> __( 'Price per row', TM_EPO_TRANSLATION ), "value"=>"row" ),
						array( "text"=> __( 'Fee', TM_EPO_TRANSLATION ), "value"=>"fee" ),
						array( "text"=> __( "Quantity Fee", TM_EPO_TRANSLATION ), "value"=>"stepfee" ),
						array( "text"=> __( "Current value Fee", TM_EPO_TRANSLATION ), "value"=>"currentstepfee" ),
					),
	...
	public final function add_setting_price_type2($name=""){
		return array(
					...
					"options"	=> array(
						...
						array( "text"=> __( "Percent of the original price per char", TM_EPO_TRANSLATION ), "value"=>"charpercent" ),
						array( "text"=> __( 'Price per char (no first char)', TM_EPO_TRANSLATION ), "value"=>"charnofirst" ),
						array( "text"=> __( 'Price per char (no n-th char)', TM_EPO_TRANSLATION ), "value"=>"charnon" ),
						array( "text"=> __( 'Price per char (no n-th char and no spaces)', TM_EPO_TRANSLATION ), "value"=>"charnonnospaces" ),
						array( "text"=> __( "Percent of the original price per char (no first char)", TM_EPO_TRANSLATION ), "value"=>"charpercentnofirst" ),
						array( "text"=> __( "Percent of the original price per char (no n-th char)", TM_EPO_TRANSLATION ), "value"=>"charpercentnon" ),
						array( "text"=> __( "Percent of the original price per char (no n-th char and no spaces)", TM_EPO_TRANSLATION ), "value"=>"charpercentnonnospaces" ),
						array( "text"=> __( 'Price per char (no spaces)', TM_EPO_TRANSLATION ), "value"=>"charnospaces" ),
						array( "text"=> __( "Fee", TM_EPO_TRANSLATION ), "value"=>"fee" ),
						array( "text"=> __( "Quantity Fee", TM_EPO_TRANSLATION ), "value"=>"stepfee" ),
						array( "text"=> __( "Current value Fee", TM_EPO_TRANSLATION ), "value"=>"currentstepfee" ),
	...
	public final function add_setting_freechars($name="",$args=array()){
		return array_merge(array(
					...
					"label"				=> __( 'Free chars', TM_EPO_TRANSLATION ),
					"desc" 				=> __( 'Enter the number of free chars.', TM_EPO_TRANSLATION )
				),$args);
	}
	...
	public final function add_setting_use_images($name=""){
		return array(
					...
					"options"	=> array(
						...
						array( "text"=> __( 'Start of the label', TM_EPO_TRANSLATION ), "value"=>"start" ),
						array( "text"=> __( 'End of the label', TM_EPO_TRANSLATION ), "value"=>"end" )
					),
	...
	public final function add_setting_swatchmode($name=""){
		return array(
					...
					"options"	=> apply_filters("wc_epo_add_setting_swatchmode", array(
						array( "text"=> __( 'No', TM_EPO_TRANSLATION ), "value"=>"" ),
						array( "text"=> __( 'Show label', TM_EPO_TRANSLATION ), "value"=>"swatch" ),
						array( "text"=> __( 'Show description', TM_EPO_TRANSLATION ), "value"=>"swatch_desc" ),
					    array( "text"=> __( 'Show label and description', TM_EPO_TRANSLATION ), "value"=>"swatch_lbl_desc" ),
					    array( "text"=> __( 'Show image', TM_EPO_TRANSLATION ), "value"=>"swatch_img" ),
					    array( "text"=> __( 'Show image and label', TM_EPO_TRANSLATION ), "value"=>"swatch_img_lbl" ),
					    array( "text"=> __( 'Show image and description', TM_EPO_TRANSLATION ), "value"=>"swatch_img_desc" ),
					    array( "text"=> __( 'Show image, label and description', TM_EPO_TRANSLATION ), "value"=>"swatch_img_lbl_desc" )
					)
									),
					"label"		=> __( 'Enable Swatch mode', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Swatch mode will show a tooltip when Use image replacements is active.', TM_EPO_TRANSLATION )
				);
	}
	...
	public final function add_setting_items_per_row($name=""){
		return array('_multiple_values'=>array(
				array(
					...
					"default"	=> "",
					"type"		=> "text",
					"extra" 	=> "<span class='tc-enable-responsive'>".__( 'Show responsive values', TM_EPO_TRANSLATION )." <span class='off tcfa tcfa-desktop'></span><span class='on tcfa tcfa-tablet tm-hidden'></span></span>",
					"tags"		=> array( "class"=>"n", "id"=>"builder_".$name."_items_per_row", "name"=>"tm_meta[tmfbuilder][".$name."_items_per_row][]" ),
					"label"		=> __( 'Items per row (Desktops and laptops)', TM_EPO_TRANSLATION ),
				...
				array(
					...
					"label"		=> __( 'Items per row (Tablets landscape)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				),
				...
				array(
					...
					"label"		=> __( 'Items per row (Tablets portrait)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				),
				...
				array(
					...
					"label"		=> __( 'Items per row (Smartphones)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				),
				...
				array(
					...
					"label"		=> __( 'Items per row (iPhone 5)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				),
				...
				array(
					...
					"label"		=> __( 'Items per row (iPhone 6)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				),
				...
				array(
					...
					"label"		=> __( 'Items per row (Samnsung Galaxy)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				),
				...
				array(
					...
					"label"		=> __( 'Items per row (Galaxy Tablets landscape)', TM_EPO_TRANSLATION ),
					"desc" 		=> __( 'Use this field to make a grid display. Enter how many items per row for the grid or leave blank for normal display.', TM_EPO_TRANSLATION )
				)
	...
	public final function add_element($name="",$settings=array(), $is_addon=false,$tabs_override=array()){
		...
		return array_merge( 
				...
				!empty($tabs_override["label_options"])?$this->_prepend_tab( $name."1", __( "Label options", TM_EPO_TRANSLATION ),"closed","tma-tab-label" ):array(),
				!empty($tabs_override["general_options"])?$this->_prepend_tab( $name."2", __( "General options", TM_EPO_TRANSLATION ),"open","tma-tab-general" ):array(),
				!empty($tabs_override["conditional_logic"])?$this->_prepend_tab( $name."3", __( "Conditional Logic", TM_EPO_TRANSLATION ),"closed","tma-tab-logic" ):array(),
				!empty($tabs_override["css_settings"])?$this->_prepend_tab( $name."4", __( "CSS settings", TM_EPO_TRANSLATION ),"closed","tma-tab-css" ):array(),
				!empty($tabs_override["woocommerce_settings"])?$this->_prepend_tab( $name."5", __( "WooCommerce settings", TM_EPO_TRANSLATION ),"closed","tma-tab-woocommerce" ):array(),
				...
				!empty($tabs_override["css_settings"])?array(
					...
					array(
						...
						"label"		=> __( 'Element container id', TM_EPO_TRANSLATION ),
						"desc" 		=> __( 'Enter an id for the container of the element.', TM_EPO_TRANSLATION )
					)
				):array(),
				...
				!empty($tabs_override["woocommerce_settings"])?array(
					array(
						...
						"label"				=> __( 'Hide element label in cart', TM_EPO_TRANSLATION ),
						"desc" 				=> __( 'Choose whether to hide the element label in the cart or not.', TM_EPO_TRANSLATION )
					),
					array(
						...
						"label"				=> __( 'Hide element value in cart', TM_EPO_TRANSLATION ),
						"desc" 				=> __( 'Choose whether to hide the element value in the cart or not.', TM_EPO_TRANSLATION )
					),
					array(
						...
						"label"				=> __( 'Hide element label in order', TM_EPO_TRANSLATION ),
						"desc" 				=> __( 'Choose whether to hide the element label in the order or not.', TM_EPO_TRANSLATION )
					),
					array(
						...
						"label"				=> __( 'Hide element value in order', TM_EPO_TRANSLATION ),
						"desc" 				=> __( 'Choose whether to hide the element value in the order or not.', TM_EPO_TRANSLATION )
					),
					array(
						...
						"label"				=> __( 'Hide element label in floating totals box.', TM_EPO_TRANSLATION ),
						"desc" 				=> __( 'Choose whether to hide the element label in the floating totals box or not.', TM_EPO_TRANSLATION )
					),
					array(
						...
						"label"				=> __( 'Hide element value in floating totals box', TM_EPO_TRANSLATION ),
						"desc" 				=> __( 'Choose whether to hide the element value in the floating totals box or not.', TM_EPO_TRANSLATION )
					)
				):array(),
	...
	private function builder_sub_options( $options=array(), $name="multiple_selectbox_options", $counter=NULL , $default_value=NULL) {
		...
		if ($name == "multiple_radiobuttons_options" || $name == "multiple_checkboxes_options"){
			...
			$uploadl = '&nbsp;<span data-tm-tooltip-html="'.esc_attr(__( "Choose the image for the lightbox.", TM_EPO_TRANSLATION )).'" class="tm_upload_button tm_upload_buttonl cp_button tm-tooltip"><i class="tcfa tcfa-upload"></i></span>';
			$class= " withupload";
		}
