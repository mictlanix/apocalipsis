	...
	function widget( $args, $instance ) 
	{
		...
		<div>
			...
			<div class="input-group" style="width:100%">
				...
				<input class="es_textbox_class form-control" style="display:table-cell" placeholder="Tu e-mail" name="es_txt_email" id="es_txt_email" onkeypress="if(event.keyCode==13) es_submit_page('<?php echo $url; ?>')" value="" maxlength="225" type="text">
				<span class="input-group-btn" style="display:table-cell">
			        <button class="btn btn-default btn-rojo" name="es_txt_button" id="es_txt_button" onClick="return es_submit_page('<?php echo $url; ?>')" type="button">ENVIAR</button>
			    </span>
