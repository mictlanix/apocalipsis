...
$general = array(
	...
	'general'  => array(
		...
		array(
			...
			'desc' 		=> __( 'Let users upload a custom avatar as profile picture.', 'yith-woocommerce-customize-myaccount-page' ),
			'type' 		=> 'checkbox',
		...
		array(
			...
			'default'  => 'sidebar',
			'type'     => 'radio',
			'desc_tip' =>  __( 'Choose the style for the "My Account" menu', 'yith-woocommerce-customize-myaccount-page' ),
			'options'  => array(
		...
		array(
			...
			'type' 		=> 'select',
			'options'	=> yith_wcmap_endpoints_option_default(),
		...
		array(
			...
			'default'  => '#777777',
			'type'     => 'color',
			'desc' 	   =>  __( 'Choose the menu item color.', 'yith-woocommerce-customize-myaccount-page' ),
		),
		...
		array(
			...
			'default'  => '#000000',
			'type'     => 'color',
			'desc' 	   =>  __( 'Choose the menu item color on mouse hover.', 'yith-woocommerce-customize-myaccount-page' ),
		),
		...
		array(
			...
			'default'  => '#ffffff',
			'type'     => 'color',
			'desc' 	   =>  __( 'Choose the color of logout text on mouse hover.', 'yith-woocommerce-customize-myaccount-page' ),
		),
