...
echo " \n/* -- Page BG -- */\n";
echo legacy_css_background("html, #ws_menu_editor .ws_editbox", "page-bg", "1.0") . "\n";
...
echo " \n/* -- Box Head -- */\n";
$legacystr = " .postbox .hndle, .stuffbox .hndle, .welcome-panel h2, .settings_page_menu_editor .ui-dialog-titlebar";
