...
function legacy_custom_login() {
    ...
    echo legacy_css_background("body, #wp-auth-check-wrap #wp-auth-check", "login-background") . "\n";
    ...
    echo legacy_css_bgcolor(".login form .input, .login form input[type=checkbox], .login input[type=text]", "login-input-bg-color", ($legacyadmin['login-input-bg-opacity']) == "" ? "0.5" : $legacyadmin['login-input-bg-opacity']) . "\n";
    echo legacy_css_bgcolor(".login form .input:hover, .login form input[type=checkbox]:hover, .login input[type=text]:hover, .login form .input:focus, .login form input[type=checkbox]:focus, .login input[type=text]:focus", "login-input-bg-color", ($legacyadmin['login-input-bg-hover-opacity']) == "" ? "0.8" : $legacyadmin['login-input-bg-hover-opacity']) . "\n";
    ...
    /* login error message */
    echo legacy_css_bgcolor(".login #login_error, .login .message", "login-input-bg-color", ($legacyadmin['login-input-bg-opacity']) == "" ? "0.5" : $legacyadmin['login-input-bg-opacity']) . "\n";
