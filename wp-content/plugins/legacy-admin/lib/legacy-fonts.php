...
function legacy_css_fonts() {
    ...
    $menufont = "'Roboto Condensed', Arial, Helvetica, sans-serif ";
    $buttonfont = "'Roboto Condensed', Arial, Helvetica, sans-serif ";
    $headingfont = "'Roboto Condensed',  Arial, Helvetica, sans-serif";
    $pageheadfont = "'Source Sans Pro',  Arial, Helvetica, sans-serif";
