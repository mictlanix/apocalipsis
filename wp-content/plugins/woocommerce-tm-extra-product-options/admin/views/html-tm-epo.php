...
?>
        ...
        <p class="toolbar">
            <button type="button" class="tm-button fr button button-primary tm_add_epo" <?php disabled( ( count($attributes)>0 ), false ); ?>><?php _e( 'Add Extra Option', TM_EPO_TRANSLATION ); ?></button>
            <span class="fr">
<?php
