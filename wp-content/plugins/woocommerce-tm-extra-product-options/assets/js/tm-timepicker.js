...
(function (factory) {
		...
		_onTimeChange: function () {
			...
			if (this.$timeObj) {
				if (pickerTimeFormat === o.timeFormat) {
					...
					this.$timeObj.text($.tm_datepicker.formatTime(pickerTimeFormat, this, o) + pickerTimeSuffix);
				}
			}
	...
	*/
	...
	$.tm_datepicker._setDateDatepicker = function (target, _date) {
		...
		if (tp_inst && tp_date) {
			...
			date = $.tm_timepicker.timezoneAdjust(date, tp_inst.timezone);
			tp_date = $.tm_timepicker.timezoneAdjust(tp_date, tp_inst.timezone);
		}
	...
	*/
	...
	$.tm_timepicker.datetimeRange = function (startTime, endTime, options) {
		$.tm_timepicker.handleRange('datetimepicker', startTime, endTime, options);
	};
