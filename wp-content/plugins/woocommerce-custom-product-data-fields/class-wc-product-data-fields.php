...
if(!class_exists('WC_Product_Data_Fields')){
  ...
  class WC_Product_Data_Fields {
      ...
      /**
        ...
        /*
        wp_enqueue_style( 'wcpdf-main-css', plugins_url( 'assets/css/wcpdf-main.min.css' , __FILE__ ), array(), '1.0.2' );
        wp_enqueue_style( 'wp-color-picker' );
        wp_enqueue_script( 'wcpdf-main-js', plugins_url( 'assets/js/wcpdf-main.min.js' , __FILE__ ), array('jquery', 'wp-color-picker', 'jquery-ui-datepicker'), '', true );
        */
